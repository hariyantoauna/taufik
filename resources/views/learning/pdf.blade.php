        ...
        <div class="card-body">
            <div>
                <form action="{{ route('pdf.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="pdf_url" class="form-label">PDF (GOOGLE DRIVE)</label>
                        <input type="url" class="form-control" name="pdf_url" id="pdf_url">
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        @if (auth()->id() === $item->user_id ||
                            ...
                            <form action="{{ route('soft.delete', ['model' => 'pdf', 'id' => $item->id]) }}" method="POST"
