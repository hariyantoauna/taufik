        ...
        <div class="card-body">
            <div>
                <form action="{{ route('canva.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="canva_url" class="form-label">Url Canva</label>
                        <input type="url" class="form-control" name="canva_url" id="canva_url">
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        @if (auth()->id() === $item->user_id ||
                            ...
                            <form action="{{ route('soft.delete', ['model' => 'canva', 'id' => $item->id]) }}"
                    ...
                    {{-- Desain Canva atau PDF --}}
                    @if (!empty($item->canva_url))
                        <h6 class="mb-2 fw-bold">📄 Desain Canva</h6>
